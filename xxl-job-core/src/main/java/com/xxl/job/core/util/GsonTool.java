...
public class GsonTool {
    ...
    public static <T> ReturnT<T> fromJsonToReturnT(String json, Class<T> genericClass) {
        return gson.fromJson(json,  new ParameterizedType4ReturnT(ReturnT.class, new Class[]{genericClass}));
    }
